  ...
  '/entwicklung': {
    ...
    schemas: [{
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Bietet CME Elektronikentwicklung für Energiesysteme und Ladeinfrastruktur an?', acceptedAnswer: { '@type': 'Answer', text: 'Ja, wir entwickeln Elektronik für die Energiewende – vom Wechselrichter bis zur Wallbox. PV-Wechselrichter, DC/DC- und AC/DC-Wandler, Wallbox-Elektronik, Batteriemanagementsysteme (BMS), Smart Charging und V2G-Lösungen.' }},
