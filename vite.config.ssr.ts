...
export default defineConfig({
  ...
  ssr: {
    // react-helmet-async liegt nur als CommonJS vor. Bleibt es extern, scheitert
    // der Import der benannten Exporte je nach Lader ("does not provide an
    // export named 'Helmet'"). Mitgebuendelt loest Vite das Zusammenspiel auf.
