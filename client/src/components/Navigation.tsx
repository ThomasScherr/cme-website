  ...
  const items: NavItem[] = [
    {
      ...
      dropdown: [
        ...
        { label: isDE ? 'Simulation & Toolchain' : 'Simulation & Toolchain', href: '/entwicklung/simulation' },
        { label: isDE ? 'Validierung & EMV' : 'Validation & EMC', href: '/entwicklung/validierung-emv' },
        { label: 'UX & Interface Engineering', href: '/entwicklung/ux-interface-engineering' },
        { label: isDE ? 'Software Engineering & Digitale Systeme' : 'Software Engineering & Digital Systems', href: '/entwicklung/software-digitale-systeme' },
        { label: isDE ? 'KI-gestützte Entwicklung' : 'AI-Powered Development', href: '/entwicklung/ki-entwicklung' },
      ],
    },
    {
