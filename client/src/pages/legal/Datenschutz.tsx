...
function DatenschutzDE() {
  return (
    <>
      ...
      <p className="text-gray-600 leading-relaxed text-sm font-semibold uppercase">
      ...
      <ul className="text-gray-600 text-sm list-disc pl-6 space-y-1">
      ...
      <p className="text-gray-500 text-xs mt-12 border-t border-gray-200 pt-6">
