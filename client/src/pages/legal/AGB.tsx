...
function AGBContentDE() {
  return (
    <>
      ...
      <p className="text-gray-600 leading-relaxed fluid-small">
        (2) Für aufgetretene und rechtzeitig gerügte Mängel bei den nach Ausfall- und Freigabemuster gelieferten Waren und Teilen haften wir nur dann, wenn die gelieferten Teile von denen dem Kunden vorgelegten und für gut befundenen Ausfall- und Freigabemuster abweichen.
      </p>
      <p className="text-gray-600 leading-relaxed fluid-small">
        (3) Unsere Mängelhaftung setzt voraus, dass der Kunde erkennbare Mängel gemäß § 377 HGB innerhalb einer Frist von 10 Tagen nach Empfang der Ware schriftlich spezifiziert gerügt hat. Später auftretende Mängel sind innerhalb der gleichen Frist, gerechnet ab Entdeckung, schriftlich spezifiziert zu rügen.
      </p>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <p className="text-gray-600 leading-relaxed fluid-small">
        (7) Die vorstehende Haftungsbeschränkung gilt nicht, soweit die Schadensursache auf Vorsatz oder grober Fahrlässigkeit beruht. Sie gilt ferner nicht, wenn der Auftraggeber Ansprüche aus der Verletzung des Lebens, des Körpers oder der Gesundheit geltend macht.
      </p>
      <p className="text-gray-600 leading-relaxed fluid-small">
        (8) Sofern wir fahrlässig eine wesentliche Vertragspflicht verletzen, ist unsere Ersatzpflicht auf den vertragstypischen, vorhersehbaren Schaden begrenzt.
      </p>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <p className="text-gray-600 leading-relaxed fluid-small">
        (3) Gerichtsstand ist Dortmund. Dies gilt auch für Wechsel- und Scheckklagen, insbesondere für Ansprüche aus dem Mahnverfahren.
      </p>
      <p className="text-gray-600 leading-relaxed fluid-small">
...
function AGBContentEN() {
  return (
    <>
      {/* § 1 Scope */}
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 1 Scope of Application</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 2 Contract Conclusion – Written Form</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 3 Scope of Deliveries and Services</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      {/* § 4 Delivery Periods */}
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 4 Delivery Periods</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 5 Transfer of Risk, Dispatch, Packaging</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 6 Prices, Payment Terms, Securities</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      {/* § 7 Warranty */}
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 7 Warranty</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 8 Customer-Supplied Materials</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      {/* § 9 Other Claims */}
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 9 Other Claims</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 10 Retention of Title</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      {/* § 11 Termination */}
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 11 Termination</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <h2 className="text-xl font-bold text-cme-dark mt-10">§ 12 Place of Performance – Jurisdiction – Scope</h2>
      <p className="text-gray-600 leading-relaxed fluid-small">
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="container">
          <div className="max-w-3xl mx-auto prose prose-gray">
            ...
            {isDE ? <AGBContentDE /> : <AGBContentEN />}
