  ...
  return (
    <Layout>
      <SEO
        ...
        descriptionDE={'Kontakt zu CME Control Motion Electronics in Dortmund. Elektronikentwicklung & EMS-Fertigung – Beratung, Projektanfrage oder Besuch vor Ort. Wir melden uns schnellstmöglich.'}
        descriptionEN={'Contact CME Control Motion Electronics in Dortmund. Electronics development & EMS manufacturing – consultation, project inquiry or on-site visit. We will get back to you as soon as possible.'}
        path='/kontakt'
        enPath='/en/contact'
