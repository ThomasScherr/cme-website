...
const faqCluster3 = [
  ...
  },
  {
    ...
    answerDE: 'Ja, wir entwickeln Elektronik für die Energiewende – vom Wechselrichter bis zur Wallbox. Unser Leistungsspektrum umfasst PV-Wechselrichter und String-Inverter, DC/DC- und AC/DC-Wandler, Wallbox- und Ladeinfrastruktur-Elektronik, Batteriemanagementsysteme (BMS), Smart Charging und V2G-Lösungen sowie Energiespeicher und Netzintegration. Wir beherrschen die besonderen Herausforderungen der Leistungselektronik in Energiesystemen: hohe Wirkungsgrade, bidirektionale Energieflüsse, Netzkonformität und die sichere Handhabung von Hochspannungen.',
    answerEN: 'Yes, we develop electronics for the energy transition – from inverters to wallboxes. Our range includes PV inverters and string inverters, DC/DC and AC/DC converters, wallbox and charging infrastructure electronics, battery management systems (BMS), smart charging and V2G solutions, as well as energy storage and grid integration. We master the special challenges of power electronics in energy systems: high efficiency, bidirectional energy flows, grid compliance, and safe handling of high voltages.',
  },
  {
