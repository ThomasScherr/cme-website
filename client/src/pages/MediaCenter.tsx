...
const DOWNLOADS = [
  {
    ...
    downloadUrl: '/manus-download/CME_Logo_RGB_R_f491fb76.png?filename=CME_Logo_RGB_R.png',
  ...
  },
  {
    ...
    previewUrl: '/manus-storage/CME_Logo_RGB_R_f491fb76.png',
    downloadUrl: '/manus-download/CME_Logo_RGB_R_f5eaab72.eps?filename=CME_Logo_RGB_R.eps',
    filename: 'CME_Logo_RGB_R.eps',
    hasPreview: true,
  },
  {
    label: 'Logo weiß horizontal',
    description: 'Für dunkle Hintergründe (PNG)',
    previewUrl: '/manus-storage/CME_Logo_CMYK_R_5eca81b3.png',
    downloadUrl: '/manus-download/CME_Logo_CMYK_R_5eca81b3.png?filename=CME_Logo_weiss_R.png',
    filename: 'CME_Logo_weiss_R.png',
    hasPreview: true,
    darkBg: true,
  },
  {
    ...
    downloadUrl: '/manus-download/CME_Logo_RGB_C_7c6c92fe.png?filename=CME_Logo_RGB_C.png',
  ...
  },
  {
    ...
    description: 'Vektordatei (EPS)',
    previewUrl: '/manus-storage/CME_Logo_RGB_C_7c6c92fe.png',
    downloadUrl: '/manus-download/CME_Logo_RGB_C_6f72d7ef.eps?filename=CME_Logo_RGB_C.eps',
  ...
  },
  {
    ...
    description: 'Vektordatei (EPS)',
    previewUrl: '/manus-storage/CME_Logo_RGB_C_7c6c92fe.png',
    downloadUrl: '/manus-download/CME_Logo_CMYK_C_81cdc5d5.eps?filename=CME_Logo_CMYK_C.eps',
  ...
  },
  {
    ...
    downloadUrl: '/manus-download/CME_Teamfoto_Katzer_Markmann_395b2cb7.png?filename=CME_Teamfoto_Katzer_Markmann.png',
