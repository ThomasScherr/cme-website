...
const marketSegments: MarketSegment[] = [
  ...
  },
  {
    ...
    taglineDE: 'Leistungselektronische Komponenten für Energiesysteme und Ladeinfrastruktur.',
    taglineEN: 'Power electronic components for energy systems and charging infrastructure.',
    applicationsDE: [
      'PV-Wechselrichter & String-Inverter',
      'DC/DC- & AC/DC-Wandler',
      'Wallbox & Ladeinfrastruktur',
      'Batteriesysteme & BMS',
      'Wallbox-Steuerungselektronik',
      'Leistungsstufen & Gate-Treiber',
    ],
    applicationsEN: [
      ...
      'Battery systems & BMS',
      'Wallbox control electronics',
      'Power stages & gate drivers',
    ],
    challengesDE: [
