...
export default function UxInterfaceEngineering() {
  return (
    <SubPageTemplate
      ...
      metaDescriptionDE="UX & Interface Engineering für technische Systeme. Bediensoftware, HMI-Design und Nutzeranalyse – von der Konzeption bis zur Serienreife."
      metaDescriptionEN="UX & interface engineering for technical systems. Operating software, HMI design and user analysis – from concept to series production."
