...
export default function EMotorDesign() {
  return (
    <SubPageTemplate
      ...
      metaDescriptionDE="E-Motor Design: Auslegung, Berechnung und Optimierung von EC-, DC- und Synchronmotoren. Magnetkreis-Simulation und thermische Analyse."
      metaDescriptionEN="E-motor design: layout, calculation and optimization of EC, DC and synchronous motors. Magnetic circuit simulation and thermal analysis."
