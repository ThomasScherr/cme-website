  ...
  return (
    <>
      <SubPageTemplate
        ...
        metaDescriptionDE="KI-gestützte Elektronikentwicklung: Machine Learning für Leistungselektronik, Antriebssysteme und Embedded-Anwendungen. Edge-AI und Echtzeit-Inferenz."
        metaDescriptionEN="AI-powered electronics development: machine learning for power electronics, drive systems and embedded applications. Edge AI and real-time inference."
