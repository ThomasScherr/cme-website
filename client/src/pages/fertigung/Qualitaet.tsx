...
export default function Qualitaet() {
  return (
    <SubPageTemplate
      ...
      titleDE="Qualitätsmanagement ISO 9001 & 14001"
      titleEN="Quality Management ISO 9001 & 14001"
      ...
      metaDescriptionDE="Qualitätsmanagement in Dortmund: ISO 9001 & 14001 zertifiziert. AOI, Röntgeninspektion und lückenlose Rückverfolgbarkeit bei CME."
      metaDescriptionEN="Quality management in Dortmund: ISO 9001 & 14001 certified. AOI, X-ray inspection and complete traceability at CME."
      ...
      ctaDE="Qualitätsberatung anfragen"
      ctaEN="Request Quality Consultation"
      features={[
        {
