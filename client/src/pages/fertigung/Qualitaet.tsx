  ...
  return (
    <SubPageTemplate
      ...
      features={[
        ...
        {
          de: 'Wareneingangskontrolle & IPC-Prüfung',
          en: 'Incoming Goods Inspection & IPC Testing',
          icon: PackageCheck,
          bulletsDE: [
            'Stichprobenbasierte oder 100%-Eingangsprüfung aller angelieferten Bauteile und Materialien',
            'Prüfung auf Echtheit, Lagerung, Verpackungsintegrität und Kennzeichnung (Anti-Counterfeiting)',
            'Abgleich mit Komponentendatenblättern und freigegebenen Approved Vendor Lists (AVL)',
            'Bewertung nach IPC-A-610 und kundenspezifischen Wareneingangsvorschriften',
          ],
          bulletsEN: [
            'Sample-based or 100% incoming inspection of all delivered components and materials',
            'Verification of authenticity, storage, packaging integrity and labeling (anti-counterfeiting)',
            'Cross-check with component datasheets and approved vendor lists (AVL)',
            'Assessment per IPC-A-610 and customer-specific incoming goods specifications',
          ],
        },
        {
          ...
          bulletsDE: [
            ...
            'Prüfung von Leiterplatten nach IPC-A-600 auf Laminate, Oberflächen und Bohrungen',
            'Schulung und Zertifizierung des Prüfpersonals als IPC-Certified Inspection Technician (CIS)',
          ...
          bulletsEN: [
            ...
            'Training and certification of inspection personnel as IPC Certified Inspection Technician (CIS)',
