    ...
    sections: [
      ...
      },
      {
        ...
        fields: featureFields([
          ...
          { de: 'FPGA-Entwicklung', en: 'FPGA Development' },
    ...
    sections: [
      ...
      },
      {
        ...
        fields: featureFields([
          ...
          { de: 'Edge-Inferenz auf Embedded-Zielen – Deployment trainierter Modelle auf MCUs und FPGAs mit Fokus auf Latenz, Speicherbedarf und Energieverbrauch', en: 'Edge inference on embedded targets – Deployment of trained models on MCUs and FPGAs with focus on latency, memory footprint and power consumption' },
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'content', label: 'Seiteninhalt', fields: [
        ...
        { key: 'subtitle', label: 'Untertitel', type: 'text', defaultDe: 'Embedded Software, FPGA-Entwicklung und digitale Systemarchitekturen', defaultEn: 'Embedded software, FPGA development and digital system architectures' },
      ] },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: 'headline', label: 'Überschrift', type: 'text', defaultDe: 'Direkter Draht zu unseren Fachleuten.', defaultEn: 'Direct line to our specialists.' },
